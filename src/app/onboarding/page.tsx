        ...
        {currentView === "profile" && (
          <form onSubmit={handleSaveProfileStep} className="space-y-6">
            <div className="p-6 sm:p-8 rounded-2xl bg-card border border-border shadow-xs space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                ...
                <div className="space-y-1.5">
                  ...
                  <select
                    ...
                    className="w-full h-10 rounded-xl bg-card border border-border px-3 text-xs text-foreground focus:outline-none focus:border-blue-500"
                  >
              ...
              <div className="space-y-2">
                <label className="block text-xs font-semibold text-foreground/80 tracking-wide uppercase">
                  Skills & Technologies <span className="text-blue-500">*</span>
                </label>
                ...
                <div className="flex flex-wrap gap-1.5 pt-1">
                  {skills.map((skill) => (
                    <span
                      key={skill}
                      className="inline-flex items-center gap-1 px-2.5 py-1 rounded-lg bg-blue-500/10 text-blue-700 dark:text-blue-300 border border-blue-500/20 text-xs font-medium"
                    >
                      {skill}
                      <button
                        type="button"
              ...
              <div className="space-y-2">
                ...
                <div className="p-4 rounded-xl border border-dashed border-border hover:border-blue-500/50 transition-colors bg-muted/20 flex flex-col sm:flex-row items-center justify-between gap-4">
                  <div className="flex items-center gap-3">
              ...
              <div className="space-y-1.5">
                ...
                <textarea
                  ...
                  className="w-full rounded-xl bg-card border border-border p-3 text-xs text-foreground placeholder:text-muted-foreground focus:outline-none focus:border-blue-500 transition-colors"
                />
              </div>
            ...
            <div className="p-6 sm:p-8 rounded-2xl bg-card border border-border shadow-xs space-y-6">
              ...
              <div className="text-center space-y-3 py-2">
                ...
                {currentVerificationStatus === "rejected" && (
                  <>
                    <div className="w-14 h-14 rounded-2xl bg-primary/10 text-rose-600 dark:text-rose-400 flex items-center justify-center mx-auto shadow-sm">
                      <ShieldAlert className="w-7 h-7" />
                    </div>
                    <div className="space-y-1">
                      <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-primary/10 text-rose-600 dark:text-rose-400 border border-rose-500/20 text-xs font-bold">
                        <AlertCircle className="w-3.5 h-3.5" />
              ...
              <div className="pt-2 flex flex-col sm:flex-row items-center justify-between gap-3">
                {currentVerificationStatus === "rejected" || currentVerificationStatus === "needs_information" ? (
                  <Button
                    ...
                    className="w-full sm:w-auto h-11 px-6 text-sm font-semibold shadow-md shadow-blue-600/20"
