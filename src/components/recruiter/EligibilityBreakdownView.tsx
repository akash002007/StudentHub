...
export function EligibilityBreakdownView({
  ...
  const getStatusBadge = () => {
    switch (eligibility.status) {
      case "ELIGIBLE":
        return (
          <span className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-xs font-bold bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 border border-blue-500/30">
      ...
      case "REQUIRES_MANUAL_REVIEW":
        return (
          <span className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-xs font-bold bg-amber-500/10 text-amber-600 dark:text-amber-400 border border-blue-500/30">
      ...
      default:
        return (
          <span className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-xs font-bold bg-primary/10 text-rose-600 dark:text-rose-400 border border-rose-500/30">
