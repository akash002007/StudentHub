...
export function VerificationBanner() {
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="space-y-1">
            <div className="flex items-center gap-2 flex-wrap">
              ...
              <span className="text-[11px] px-2 py-0.5 rounded-md bg-blue-500/20 font-medium">
                Action Required
              </span>
            </div>
  ...
  if (status === "rejected") {
    return (
      <div className="mb-6 p-4 sm:p-5 rounded-2xl bg-primary/10 border border-rose-500/30 text-rose-900 dark:text-rose-200 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 shadow-xs">
        <div className="flex items-start gap-3">
          <div className="w-9 h-9 rounded-xl bg-primary/20 text-rose-600 dark:text-rose-400 flex items-center justify-center shrink-0 mt-0.5">
