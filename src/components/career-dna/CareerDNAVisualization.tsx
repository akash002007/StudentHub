              ...
              return (
                ...
                >
                  <div className="flex items-center gap-2.5">
                    <div className={`w-7 h-7 rounded-lg flex items-center justify-center ${source.active ? "bg-blue-500 text-white" : "bg-muted text-muted-foreground"}`}>
                      <Icon className="w-3.5 h-3.5" />
                    </div>
        ...
        <div className="lg:col-span-5 p-5 rounded-2xl bg-card border border-border space-y-4 shadow-sm flex flex-col justify-between">
          <div className="space-y-3">
            ...
            <div className="flex items-center justify-between p-3 rounded-xl bg-blue-500/10 border border-blue-500/20">
              <div>
                <span className="text-[10px] font-bold text-blue-500 uppercase tracking-wider block">Career Score</span>
            ...
            <div className="space-y-1 text-xs">
              ...
              <p className="font-bold text-blue-600 dark:text-blue-400">Full-Stack Web Development</p>
            </div>
